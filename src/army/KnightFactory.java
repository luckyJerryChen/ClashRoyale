...
public class KnightFactory extends ArmyFactory {

	public static Army create(float x,float y,JPanel mapPanel,boolean color,ArmyConf conf){
		Army army= ArmyFactory.create(x, y, mapPanel,new Knight(conf));
		...
		ImageIcon icon=null;
		if(color==false)
			icon=new ImageIcon(".\\image\\army\\Knight\\red_walk.png");
		else
			icon=new ImageIcon(".\\image\\army\\Knight\\blue_walk.png");
